...
public class II : MonoBehaviour
{
    ...
    public void Start()
    {
        ...
        _base.Add("Frerard1", new ItemInfo(
            spriteName: "Frerard 1",
            prefabName: "Frerard 1",
            visibleName: "Frerard 1",
            throwable: false
            ));
